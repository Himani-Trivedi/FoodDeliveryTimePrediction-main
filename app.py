...
<p id="location-result" style="text-color='white'"></p>
"""

# soup = BeautifulSoup(html_code, 'html.parser')
# st.components.v1.html(html_code)
# data = soup.find(id="location-result")
data = [19.0760, 72.8777]
# d1=data
...
st_folium(restaurant_map,height=350, width=700)
...
if distance>=30.0:
    st.write("No delivery available now.. as distance is more than 30 Km")
else:
